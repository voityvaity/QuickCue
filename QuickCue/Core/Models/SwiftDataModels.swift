...
typealias SessionRecord = QuickCueSchemaV2.SessionRecord
typealias TranscriptRecord = QuickCueSchemaV2.TranscriptRecord
typealias AnswerRecord = QuickCueSchemaV2.AnswerRecord
typealias PhotoRecord = QuickCueSchemaV2.PhotoRecord
typealias UsageRecord = QuickCueSchemaV2.UsageRecord
typealias ConversationMessageRecord = QuickCueSchemaV2.ConversationMessageRecord
...
enum QuickCueMigrationPlan: SchemaMigrationPlan {
    static var schemas: [any VersionedSchema.Type] { [QuickCueSchemaV1.self, QuickCueSchemaV2.self] }
